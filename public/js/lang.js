...
const en = () => {
  ...
  if (navUl) navUl.style.direction = "ltr";
  ...
  if (contactSectionBody && contactSectionTitle) {
...
const fa = () => {
  ...
  const navUl = document.querySelector(".nav-ul");
  if (navUl) navUl.style.direction = "rtl";
  let infoBoxContent = document.querySelectorAll(".info-box-content");
  if (infoBoxContent) {
    infoBoxContent.forEach((el) => {
