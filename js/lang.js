  ...
  fa: {
    ...
    services: {
      ...
      serviceThree: {
        ...
        body: "ما مصمم هستیم که هر مشکلی را که با آن روبرو هستید برطرف کنیم، ,وارتک لحیم کاری و تعمیر برد مدار الکترونیکی، تشخیص خطا، جایگزینی قطعات معیوب یا شکسته در مدارهای الکترونیکی  را برای شما فراهم می کند",
      },
      serviceFour: {
